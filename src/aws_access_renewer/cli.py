...
def parse_args():
    ...
    parser.add_argument("-p", "--ssh-port", type=int, default=22, help="Target SSH port (default: 22)")
    ...
    parser.add_argument("--version", action="version", version="AWS-ACCESS-RENEWER 1.6.0")
